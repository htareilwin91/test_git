...
$getCurrentMonth = getCurrentMonth($todaydate, $_SESSION['sess_user_id'], $db);
					...
					$body.='<table style="width:800px">
							...
							for ($r = 0; $r < count($getCurrentMonth); $r++) {
								...
								$body.="<tr>";
								$body.="<td style='border-bottom: 1px dotted #514F4F; text-align:center;'>".substr($getCurrentMonth[$r]["calendar_date"], -2)."</td>";
								$body.="<td style='border-bottom: 1px dotted #514F4F; text-align:center;'>".strtoupper($getCurrentMonth[$r]["calendar_day"])."</td>";
								$body.="<td style='border-bottom: 1px dotted #514F4F; text-align:center;'>".$intime."</td>";
								$body.="<td style='border-bottom: 1px dotted #514F4F; text-align:center; color:red;'>".$latetime."</td>";
								//$body.="<td style='border-bottom: 1px dotted #514F4F; text-align:center;'><span style='color:red;'>".$latetime."</span></td>";
								$body.="<td style='border-bottom: 1px dotted #514F4F; text-align:center;'>".$outtime."</td>";
								$body.="<td style='border-bottom: 1px dotted #514F4F; text-align:center;'>".$worktime."</td>";
								$body.="<td style='border-bottom: 1px dotted #514F4F; text-align:center;'>".$overtime."</td>";
								$body.="<td style='border-bottom: 1px dotted #514F4F; text-align:center;'>".$totaltime."</td>";
								$body.="</tr>";
...
if(mail('zinmonthet@rubbersoul.co.jp', $subject, $body, $headers))
	{
